...
Ok, hmm, is that even informative.. Well there is eQTL enrichment in all the types of QTLs tested. Though, I don't have a set of control SNPs... Let's try breaking out the QQ plots by concordance of effect directions...
...
TopSNPEffects.ByPairs %>%
  ...
  geom_abline() +
  geom_point() +
  facet_grid(rows=vars(Concordance), cols=vars(PC2)) +
  theme_bw() +
  labs(title="QQ plot of eQTL P-values", color="xQTL SNP", y="-log10(P)")
```
