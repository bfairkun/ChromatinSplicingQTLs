...
```{r}
unstandardized <- read_delim("../code/QTLs/QTLTools/chRNA.Expression.Splicing/NominalPass_Unstandardized.txt.gz", delim=' ', col_names=c(colnames(PermutationPass.dat)[c(2:12, 17:20)], "best_hit"))


colnames(PermutationPass.dat)
