...
dat.for.scatter.P %>%
  ...
  unnest(tidied, .drop = T) %>%
  unnest(data) %>%
  count(SuperAnnotation.simplified, gene)
...
```{r}
nudt14.boxplot.dat <- read_tsv("../code/scratch/Plot_sQTLeQTLGWASColocs/DatForBoxplots.NUDT14.sQTL.chRNA.tsv") %>%
  dplyr::rename("value"=2)
lm.fit <- lm(value~genotype,data=nudt14.boxplot.dat)
summary(lm.fit)

nudt14.boxplot.dat <- read_tsv("../code/scratch/Plot_sQTLeQTLGWASColocs/DatForBoxplots.NUDT14.sQTL.polyA.tsv") %>%
  dplyr::rename("value"=2)
lm.fit <- lm(value~genotype,data=nudt14.boxplot.dat)
summary(lm.fit)

nudt14.boxplot.dat <- read_tsv("../code/scratch/Plot_sQTLeQTLGWASColocs/DatForBoxplots.NUDT14.eQTL.chRNA.tsv") %>%
  dplyr::rename("value"=2)
lm.fit <- lm(value~genotype,data=nudt14.boxplot.dat)
summary(lm.fit)

nudt14.boxplot.dat <- read_tsv("../code/scratch/Plot_sQTLeQTLGWASColocs/DatForBoxplots.NUDT14.eQTL.polyA.tsv") %>%
  dplyr::rename("value"=2)
lm.fit <- lm(value~genotype,data=nudt14.boxplot.dat)
summary(lm.fit)
```
